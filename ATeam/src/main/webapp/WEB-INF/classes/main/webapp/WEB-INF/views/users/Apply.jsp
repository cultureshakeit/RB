									...
									<table class="table">
										...
										<tr>
											<td colspan="9"><input type="submit" class="btn"
												onclick="noticeSave()" value="등록"></td>
										</tr>
...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
	...
	<script type="text/javascript">
		...
		function onCheck() {
			...
			if (!phone && phone.length < 12) {
				alert("휴대폰 번호를 적는다. 또는 회사 전화라도 상관 없습니다.");
				return false;
			}
			form.submit();
	...
	<script type="text/javascript">
		...
		if(!$("input[name='category']").val()){
			alert("카테고리를 알기 쉽게 입력하십시오.");
			return false;
		}	
		if(!$("input[name='price']").val()){
				alert("가격을 써주세요. 단위는 필요 없습니다");
				return false;
			}
