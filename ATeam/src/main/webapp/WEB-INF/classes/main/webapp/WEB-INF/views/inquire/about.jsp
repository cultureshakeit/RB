	...
	<div id="root">
		<div class="App">
			<section class="content" id="guide-cont">
				<div class="wrap">
					<section class="howto">
						<h2 class="sub-title">자전거 대여 홈페이지의 이용 방법을 알려드립니다! .</h2>
							...
							<li class="mv moveit"><h3>
								...
								<section class="banner-01" style="overflow: hidden;">
									<sec:authorize access="isAuthenticated()">
										<a href="/inquire" class="btn btna2 mv3 moveit">「렌탈 예약 문의」보기</a>
									</sec:authorize>
									<sec:authorize access="isAnonymous()">
										<a href="javascript:loginmove();"
											class="btn btna2 mv3 moveit">「렌탈 예약 문의」보기</a>
									</sec:authorize>
								</section></li>
							<li class="mv moveit"><h3>
									<span>3</span> 자전거찾기
					...
					<section class="banner-01" style="overflow: hidden;">
						...
						<h2>
							<span>대여 요금</span>도<br> 확인하세요.
						</h2>
						<a href="/fare" class="btn btna2 mv3 moveit">서비스 요금 바로보기</a>
					</section>
