...
<div class="container row aa">
	<div class="profile col-md-4">
		<div class="card">
			<strong style="font-size: 1.25rem;">사용자 </strong>
			<h1>
			...
			<p>
				<a href="/users/index?userid=${userid }" class="button">마이페이지로</a>
			</p>
		</div>
	</div>
				...
				<div class="row">
					...
					<div class="col-md-4" style="margin: auto auto;">
						<a class="button btn"
							...
							style="background-color: firebrick;">삭제</a>
					</div>
				</div>
...
<div class="row bb container">
	<div class="cc col-md-2"
		...
		<h4>
			장바구니 <span class="price" style="color: black"><i
				class="fa fa-shopping-cart"></i> <b>${cartcount }</b></span>
		</h4>
		<p>
			총 <span class="price" style="color: black"><b>${cartsum }원</b></span>
		</p>
		<hr>
		<button class="btn button" id="p" style="cursor: pointer;">구매하기</button>
	</div>
</div>
...
$(document).ajaxSend(function(e, xhr, options) {
	...
	$("#p").on("click",function(e){
		...
		var con = confirm("이 상품을 예약 하시겠습니까?");
		if(con == true){			
		$.ajax({
			url : "/cart_insert",
			type : 'POST',
