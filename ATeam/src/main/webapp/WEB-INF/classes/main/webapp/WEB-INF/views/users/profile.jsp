					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form class="form-horizontal form-material">
								...
								<a href="../user/UserProfileUpdate?userid=<sec:authentication property='principal.member.userid'/>" class="btn label label-warning">수정</a> 
								<span class="btn label label-danger">탈퇴</span>
							</form>
						</div>
					</div>
				</div>
