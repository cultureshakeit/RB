		...
		<form name="write" style="background-color: #6daeb8"
			...
			<fieldset>
				...
				<table class="table">
					...
					<tr>
						<th style="vertical-align: middle;"><label for="cont">콘텐츠</label></th>
						<td><textarea type="cont" name="content" id="cont"
								class="cont" placeholder="내용을 입력해주세요"></textarea>
					</tr>
					<tr>
						<th style="vertical-align: middle;"><label for="cont">첨부이미지
								파일</label></th>
						<td><input type="file" name="photos"></td>
					</tr>

					<tr>
						<td colspan="2"><input type="submit" value="쓰기" class="btn"
