...
<link type="text/css" rel="stylesheet" href="/resources/tourist/css/tab_scroll_category.css"
	type="text/css" media="screen" >
<link type="text/css" rel="stylesheet" href="/resources/tourist/css/sweetalert.min.css"
	type="text/css" media="screen" >
<link type="text/css" rel="stylesheet" href="/resources/tourist/css/style.css" >
<link type="text/css" rel="stylesheet" href="/resources/tourist/css/custom_tourist.css" >
					...
					<div class="board-list">
						...
						<div class="multi-btn-wrap">
							...
							<ul class="list-unstyled multi-type-btn-wrap pull-right">
								...
								<li><button
										type="button"
										class="multi-type-btn multi-type-list-btn"
										title="리스트뷰"
									>
								...
								<li><button
										type="button"
										class="multi-type-btn multi-type-webzine-btn"
										title="웹진뷰"
									>
										<span class="sound_only">웹진뷰</span><i
								...
								<li><button
										type="button"
										class="multi-type-btn multi-type-gallery-btn"
										title="갤러리뷰"
									>
										<span class="sound_only">갤러리뷰</span><i
								...
								<li><button
										type="button"
										class="multi-type-btn multi-type-wide-btn"
										title="와이드뷰"
									>
										...
										<div class="multi-item-in">
											...
											<div class="multi-desc">
												...
												<div class="multi-subj-cont">
													<h4>
														...
														>
															...
															<i
																class="fas fa-star"
																style="color:${place.favor_true ? '#ffd700':'gray'}"
															></i>
														</a>
													</h4>
												...
												<div class="multi-info multi-info-rating">
													<span class="multi-photo"> <img
														class="user-photo"
														src="/resources/tourist/image/admin.png"
														alt="회원사진"
													>
													</span> <span class="multi-nick"> <span class="sv_wrap"> <a
													...
													<div style='width: 51px; display: inline-block; font-size: 11px;'>
														<span> <i
															class="fas fa-eye"
															style='color: #959595;'
														></i>
															<div
																style='text-align: center; width: 25px; display: inline-block; font-weight: bold;'
																class='color-black'
															>${place.views }</div>
														</span>
													</div>
													<!-- 댓글 구현 -->
													<span style=''> <i class="fas fa-comment-alt"></i> <strong class="color-black"> ${place.comments_num }</strong>
													</span>
													<!-- 좋아요 구현 chan  -->
													<span> <!-- <i class="far fa-thumbs-up"></i> 하트로 변경  -->
														<div class="tooltip1">
															<button
																...
																content_id="${ place.contentsid }"
																class="btn btn-link btn-like active"
																style='padding: 0px 12px 3px 0px;'
															>
																<i
																	class="fa${ place.like_true ? '' :'r'} fa-heart"
																	aria-hidden="true"
																	style="color: red;"
																></i> <strong class="color-green">${place.likes}</strong></span>
															</button>
												...
												<i
													class="fas fa-tags"
													style="color: gray"
												></i> <span>${fn:length(place.tag.split(","))}.</span> <span>${fn:substring(place.tag,0,45)}${ place.tag.length() > 45 ? "...":""}</span>
...
// 		$('#handleLike').click()
	    ...
	    $(document).on('click','#favorStar',function(){
			...
			var self = $(this)
			var target = 'class'
			if(flag.css('color') == 'rgb(128, 128, 128)'){
	...
	<div
		class="sidebar-left-mask sidebar-left-trigger"
		data-action="toggle"
		data-side="left"
	></div>
	<div
		class="sidebar-right-mask sidebar-right-trigger"
		data-action="toggle"
		data-side="right"
	></div>
	...
	<div
		class="modal fade all-search-modal eb-search-modal"
		aria-hidden="true"
	>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">
						<i class="fas fa-search color-grey"></i> <strong>전체 게시판 검색</strong>
					</h4>
				</div>
	...
	<div
		class="modal fade itemuse-iframe-modal"
		aria-hidden="true"
	>
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button
						data-dismiss="modal"
						class="btn-e btn-e-lg btn-e-dark"
						type="button"
					>
