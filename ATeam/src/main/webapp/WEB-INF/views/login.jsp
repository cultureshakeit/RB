...
<div class="limiter">
	<div class="container-login100">
		<div class="wrap-login100">
			<form class="login100-form validate-form" action="/login" style="justify-content: center;" method="post">
				...
				<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="아이디를 입력하세요.">
					<input id="first-name" class="input100" type="text" name="username" placeholder="ID를 입력하세요!">
					<span class="focus-input100"></span>
				</div>
				
				<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="암호를 입력하세요!">
					<input class="input100" type="password" name="password" placeholder="암호를 입력하세요!">
					<span class="focus-input100"></span>
				</div>
				
				<div class="genric-btn primary-border circle m-b-20" id="remember">
					<input type="checkbox" id="remember-me" name="remember-me" style="position: relative; top: 4px; right: 5px;"> 자동 로그인
				</div>
				...
				<div class="w-full text-center p-t-27">
					...
					<hr>
					<a href="javascript:void(0)" onclick="window.open('/forgot/forgotpw','','width=100px,heigth=100px, resize=none');"
						class="txt2"> 비밀번호를 잊으셨습니까? </a>
					<hr>
				</div>
			...
			<div class="login100-more" style="background-image: url('/resources/user/images/bg1.jpg');"></div>
		</div>
	</div>
</div>
