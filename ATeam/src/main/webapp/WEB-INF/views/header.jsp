            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="/tourist">관광지</a></li>
                        ...
                        <sec:authorize access="hasRole('ROLE_ADMIN')">
							<li class="nav-item"><a class="nav-link" href="/admin/index">관리페이지</a></li>
						</sec:authorize>
                    </ul>
                ...
                <!--    <iframe width="100%" height="245" 
	                    ...
	                    <div class="booked-wzsp-prime-in">
	                    	<div class="booked-wzsp-prime-data"> 
		                    	...
		                    	<div class="booked-wzsp-day-val">
		                    		<div class="booked-wzsp-day-number"><span class="plus">+</span>온도</div>
		            ...
		            <script type="text/javascript">
	                    ...
	                    function setWidgetData_14033(data) { 
	                    	if(typeof(data) != 'undefined' && data.results.length > 0) {
	                    		for(var i = 0; i < data.results.length; ++i) { 
	                    			var objMainBlock = document.getElementById('m-booked-prime-14033');
	                    ...
	                    var widgetSrc = "https://widgets.booked.net/weather/info?action=get_weather_info;ver=7;cityID=32868;type=5;scode=124;ltid=3457;domid=w209;anc_id=6454;countday=undefined;cmetric=1;wlangID=1;color=137AE9;wwidth=250;header_color=ffffff;text_color=333333;link_color=08488D;border_form=1;footer_color=ffffff;footer_text_color=333333;transparent=0;v=0.0.1";
	                    widgetSrc += ';ref=' + widgetUrl;
	                    widgetSrc += ';rand_id=14033';
