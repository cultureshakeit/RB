			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">관리자 메인 페이지</h4>
					</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								<div class="col-md-6 col-sm-6 col-xs-6">
									<i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
									<h4 class="text-muted vb">전체 회원</h4>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-6">
									...
									<div class="container">
										...
										<div class="col-md-2 col-sm-2 col-xs-4"
											...
											<select class="row b-none" name="type">
												<option value="U"
													<c:out value="${pageMaker.cri.type eq 'U'?'selected':''}"/>>이름</option>
												<option value="E"
							...
							<div class="table-responsive" id="table">
								<table class="table table-striped"
									...
									<thead style="border-top: 1px solid">
										<tr>
											<th style="text-align: center; justify-content: center;">사용자 ID</th>
											<th style="text-align: center; justify-content: center;">등록 일시</th>
											<th colspan="1"
											...
											<tr id="tab">
												...
												<td class="input-group-addon"
													...
													id="ban" style="text-align: center;">
														<option value="null">선택</option>
														<option value="true">차단 해제</option>
