	...
	<div class="container">
		<div class="col-lg-8 border p-3 main-section bg-white">
			<div class="row hedding m-0 pl-3 pt-0 pb-3"
				style="justify-content: center;">자세한 사진</div>
			<div class="row m-0">
					...
					<div class="right-side-pro-detail border p-3 m-0">
						<div class="row" style="text-align: center;">
							...
							<div style="margin:10px;">
								<span class="price-pro" style="color:green">가격</span> : 
							...
							<div class="col-lg-12" style="margin-bottom: 20px;">
								<p class="tag-section">
									<strong>임대 기간</strong><br> <strong>시작일:</strong>${fn:substring(view.startdate,0,10) }
								...
								<div class="row">
									<div class="col-lg-12 pb-2">
										...
										<sec:authorize access="isAnonymous()">
											<a href="javascript:void(0)" class="btn  btn-warning w-100"
												onclick="confirms();"
												style="font-size: 1.5rem;">장바구니 지갑</a>
										</sec:authorize>
									</div>
