			...
			<fieldset>
				...
				<table class="table">
					...
					<tr>
						...
						<th style="vertical-align: middle;"><label for="t_title">첨부 이미지</label></th>
					...
					<tr>
						<th style="vertical-align: middle;"><label for="t_title">제품의 종류</label></th> 
					...
					<tr>
						<td colspan="6"><input type="submit" value="쓰기" class="btn"
							onclick="noticeSave()"> <input type="button"
							onclick="history.back();" value="돌아가기" class="btn"></td>
					</tr>
